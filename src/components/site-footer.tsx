        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1fr]">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm text-sand/70">
              A focused, modern boxing gym built for athletes, competitors, and
              new fighters ready to level up.
            </p>
            <BookTrialButton className="w-fit rounded-full bg-ember px-6 py-3 text-xs font-semibold uppercase tracking-[0.3em] text-white" />
          </div>
